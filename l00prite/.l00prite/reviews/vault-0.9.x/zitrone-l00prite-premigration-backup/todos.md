# Zitrone — open TODOs (as of 2026-07-24, 0.9.1-beta vault track)

> Refreshed at `.l00prite/` scaffold-restoration. The prior 0.8.1-era list is archived verbatim
> at `todos.0.8.1.md` (nothing was deleted). Full history: `ledger.md` +
> `/root/l00prite/zitrone-vault-ledger.md`.

## Now — 0.9.2-beta SECOND VAULT (slot B) + PUCKER BURN, Android — DECISIONS RECORDED, SPEC IN PROGRESS
