...
- Keep zitrone agent memory (this `.l00prite/`, the `/root/l00prite/zitrone-*` artifacts) local
  to the box and behind .gitignore — not committed to zitrone or to the l00prite protocol repo.
