...
export const ANDROID_BETA_VERSION = "v0.7.4-beta";
...
// must serve the same binary. Verify: sha256sum onion-site/zitrone-v0.7.4-beta.apk
export const ANDROID_BETA_SHA256 =
  "a7f3e5a35025031bb9f5d29c7f8db39b17b03040401597e0d04095a9807a6df8";
