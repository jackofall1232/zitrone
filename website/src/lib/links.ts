...
export const ANDROID_BETA_VERSION = "v0.9.4-beta";
...
// must serve the same binary. Verify: sha256sum onion-site/zitrone-v0.9.4-beta.apk
export const ANDROID_BETA_SHA256 =
  "9062c65d0db667fb8b5e790c35a4f74f144a00c9908cc7aa2a326e251e8a1eae";
