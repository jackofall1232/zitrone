...
export const ANDROID_BETA_VERSION = "v0.7.3-beta";
...
// must serve the same binary. Verify: sha256sum onion-site/zitrone-v0.7.3-beta.apk
export const ANDROID_BETA_SHA256 =
  "4f6f909155668a5dc886a21ea8bb023331d7607c83e66b52afafe113c8e3c4d6";
