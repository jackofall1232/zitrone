...
export const ANDROID_BETA_VERSION = "v0.10.0-beta";
...
// must serve the same binary. Verify: sha256sum onion-site/zitrone-v0.10.0-beta.apk
export const ANDROID_BETA_SHA256 =
  "fa183f309e3aae89cc667a7939bcec131a2913a1dc798bb1058ff52c73c877db";
