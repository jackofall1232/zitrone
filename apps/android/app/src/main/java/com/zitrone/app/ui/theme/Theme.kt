...
package com.zitrone.app.ui.theme
 ...
 */
private val ZitroneColorScheme = darkColorScheme(
    primary = Lemon,
...
@Composable
fun ZitroneTheme(content: @Composable () -> Unit) {
    // The system light/dark setting is never consulted: dark is the only theme.
    MaterialTheme(
        colorScheme = ZitroneColorScheme,
        typography = ZitroneTypography,
        shapes = ZitroneShapes,
        content = content,
    )
}
