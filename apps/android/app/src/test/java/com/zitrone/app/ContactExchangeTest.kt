...
import com.zitrone.app.ui.components.parseContactInput
import com.zitrone.app.ui.components.parseContactPayload
...
class ContactExchangeTest {
    ...
    fun `bare uuid and link have no key to pin`() {
        ...
        val fromLink = parseContactPayload("https://zitrone.example/add/$uuid")!!
